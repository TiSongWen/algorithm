...
public class ProgramTest {
    ...
    public static void test(File inputFile, File outputFile, File tempFile) throws Exception {
        ...
        String s = null;
     //   List<N> list = new ArrayList(500000);
...
//        TrieST<String> trieST = new TrieST<>();
       ...
       // final int N = 256;
        //      List<String> strings = new ArrayList<String>(500000);
//        List arrays = new ArrayList(N);
//        for (int i = 0; i < N; i++) {
//            arrays.add(new ArrayList<String>(5000));
//        }
...
//            }
//            trieST.put(sb.toString(), s);
            List list = ll.get(s.charAt(0));
            list.add(new N(s));

            // strings.add(sb.toString());
        }

//        String[] o = new String[strings.size()];
//
//        o = strings.toArray(o);
//
        for (int i = 0; i < 128; i++) {
...
//                }
//
//                return ((N)o1).s.compareTo(((N)o2).s);
//
//            }
//        });
//        for(N str: list) {
...
//        new TimeSort().sort(o, new Comparator<Object>() {
//            @Override
//            public int compare(Object o1, Object o2) {
//                //return ((N)o1).t.compareTo(((N)o2).t);
//                long n1 = ((N)o1).n;
//                long n2 = ((N)o2).n;
...
//    private static void bubble(List<String> list, Comparator<String> c) {
//        for (int i = 0; i < list.size(); i++) {
//            int max = 0;
//            int j;
//            for (j =  0; j < list.size() - i; j++) {
//                if (c.compare(list.get(max), list.get(j)) < 0) {
//                    max = j;
//                }
//            }
//            String temp = list.get(max);
//            list.set(max, list.get(j-1));
//            list.set(j - 1, temp);
//        }
//    }
...
//            for (int i = 0; i < s.length() && s.charAt(i) != ','; i++) {
//
//                n = n | ((s.charAt(i) & 0xffffffffffffffffL) << (8*(7-i)));
...
//        }
//
//        public <T> void sort(T[] a, int lo, int hi, Comparator<? super T> c) {
//
//
...
//        private  <T> void binarySort(T[] a, int lo, int hi, int start,
...
//         */
//        private  <T> int countRunAndMakeAscending(T[] a, int lo, int hi,
//                                                        Comparator<? super T> c) {
//            assert lo < hi;
//            int runHi = lo + 1;
//            if (runHi == hi)
...
//         */
//        private  <T> int gallopLeft(T key, T[] a, int base, int len, int hint,
//                                          Comparator<? super T> c) {
...
//         */
//        private  <T> int gallopRight(T key, T[] a, int base, int len,
...
//
    ...
    private static class MSD {
        ...
        private static void sort(N[] a, int lo, int hi, int d, N[] aux) {
//            if (hi < lo + M) {
//                insertion(a, lo, hi, d);
//                return;
//            }
...
//
//            for (int i = lo; i <= hi; i++) {
//                aux[count[charAt(a[i].t, d) + 1]++] = a[i];
//            }
//
//            for (int i = lo; i <= hi; i++) {
//                a[i] = aux[i-lo];
